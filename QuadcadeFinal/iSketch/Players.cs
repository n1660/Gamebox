...
namespace iSketch
{
    public class Member //: IEquatable<Member>
    {
        ...
        private IPAddress hostAdr = IPAddress.Parse("192.168.43.253");
        private TcpClient client = new TcpClient();

        public int ID { get; set; } // Für Sockets als int -> ID wird vom Host zugewiesen!
        ...
        public IPAddress Adr { get => hostAdr; set => hostAdr = value; }
        ...
        {           
            ...
            if (!host && Username != "")
            {
                ...
                this.end = new IPEndPoint(hostAdr, 4444);
