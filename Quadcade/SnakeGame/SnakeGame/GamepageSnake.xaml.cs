...
namespace test
{
    ...
    public partial class GamepageSnake : Page
    {
        ...
        public GamepageSnake(bool multiplayer)
        {
            ...
            GameCanvas.Arrange(new Rect(0, 0, Application.Current.MainWindow.DesiredSize.Width, App.Current.MainWindow.DesiredSize.Height));
            ...
            BtnRemovePlayer.Arrange(new Rect(0, 0, App.Current.MainWindow.DesiredSize.Width, Application.Current.MainWindow.DesiredSize.Height));
            ...
            foreach (UIElement el in dpButtons.Children)
            {
                ...
                el.Arrange(new Rect(0, 0, App.Current.MainWindow.DesiredSize.Width, Application.Current.MainWindow.DesiredSize.Height));
            }
